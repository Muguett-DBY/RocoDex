...
function Finale({ narrativeMode }: { narrativeMode: CstdNarrativeMode }) {
  ...
  return (
    <footer
      ...
      className="relative z-20 min-h-[90svh] border-t border-[#f4d431]/35 text-[#f2efe7]"
    >
      <div className="relative flex min-h-[90svh] items-end overflow-hidden px-5 pb-12 pt-28 md:px-10 md:pb-16 lg:px-16">
        ...
        <div className="relative mx-auto grid w-full max-w-[1440px] gap-12 lg:grid-cols-[minmax(0,1fr)_22rem] lg:items-end">
          <div className="max-w-6xl">
            ...
            <p className="cstd-finale-cstd mt-8 font-mono text-[4.5rem] font-black leading-[0.78] text-[#24e0ff] md:text-[7rem] lg:text-[8rem]">CSTD</p>
            <h2 className="cstd-finale-title mt-3 text-5xl font-black leading-[0.88] tracking-[0] md:text-7xl lg:text-[7rem]">
              STILL
          ...
          <div className="border-y border-[#24e0ff]/35 bg-[#050709]/90 px-5 py-6 font-mono">
