...
function ExecutableEvidence() {
  ...
  return (
    <section data-cstd-chapter="operator" data-cstd-scene="operator" data-cstd-executable-evidence data-cstd-home-replay={replay.id} aria-labelledby="executable-evidence-heading" className="relative z-20 border-b border-white/10 bg-[#050709] px-5 py-20 text-[#f2efe7] md:px-10 lg:px-16 lg:py-28">
      <div className="mx-auto grid max-w-[1320px] gap-10 xl:grid-cols-[minmax(20rem,0.72fr)_minmax(0,1.28fr)] xl:items-start xl:gap-16">
        <div>
          <p className="flex items-center gap-3 font-mono text-[10px] font-black text-[#24e0ff]"><FlaskConical aria-hidden="true" className="h-4 w-4" /> 04 / EXECUTABLE EVIDENCE</p>
          <h2 id="executable-evidence-heading" className="mt-5 text-4xl font-semibold leading-[1] md:text-6xl lg:text-[4rem]">案例不只可读，<span className="text-[#f4d431]">还可以运行。</span></h2>
          ...
          <div className="mt-6 flex flex-wrap gap-6">
            ...
            <CstdLink href="/lab/proof-museum" className="inline-flex items-center gap-2 font-mono text-[10px] font-black text-[#899499] hover:text-white">证据博物馆 <ArrowUpRight aria-hidden="true" className="h-4 w-4" /></CstdLink>
          </div>
        </div>
