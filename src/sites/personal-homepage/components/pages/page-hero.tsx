    ...
    >
      ...
      <div className="relative mx-auto flex w-full max-w-[1540px] flex-col justify-end px-5 pb-16 pt-28 md:px-10 lg:px-16 lg:pb-20">
        <div className="max-w-5xl">
          <p className="font-mono text-[11px] font-black text-[#f4d431]">{eyebrow}</p>
          <h1 className="mt-6 text-balance text-[2.375rem] font-semibold leading-[0.94] tracking-[0] text-white sm:text-5xl md:text-7xl md:leading-[0.9] lg:text-8xl xl:text-[7rem]">{title}</h1>
        ...
        <div aria-hidden="true" className="mt-9 flex items-center gap-3 font-mono text-[11px] font-black text-[#748187]">
