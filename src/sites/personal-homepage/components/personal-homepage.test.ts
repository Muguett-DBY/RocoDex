...
const themeEncounterSource = read("./theme-signature-experience.tsx");
...
const astralThemeSource = read("../../../app/cstd-theme-astral.css");
const themeEncounterCssSource = read("../../../app/cstd-theme-encounters.css");
...
describe("CSTD personal homepage", () => {
  ...
  test("offers exactly three persistent game worlds with distinct structural engines", () => {
    ...
    expect(themeWorldSource).toContain('data-cstd-theme-world-decoration="astral-covenant"');
    ...
    expect(assetManifestSource).toContain("/cstd-themes/astral-covenant-v1.webp");
    ...
    expect(assetManifestSource).toContain("/cstd-stage/cstd-astral-covenant-v1.webp");
    expect(themeStoreSource).toContain("UNDERWORLD FORGE");
    expect(themeStoreSource).toContain("ASTRAL COVENANT");
    ...
    expect(astralThemeSource).toContain('[data-cstd-theme-menu-theme="astral-covenant"]');
  ...
  test("gives each game world its own copy, navigation, layout, and executable interaction", () => {
    ...
    expect(personalLayoutSource).toContain('import "../cstd-theme-astral.css"');
    expect(personalLayoutSource).toContain('import "../cstd-theme-encounters.css"');
    expect(englishLayoutSource).toContain('import "../cstd-theme-encounters.css"');
    ...
    expect(themeCopySource).toContain('data-cstd-theme-copy="astral"');
    expect(gateSource).toContain("冥府档案");
    expect(gateSource).toContain("星界旅记");
    ...
    expect(astralThemeSource).toContain('[data-cstd-theme="astral-covenant"] [data-cstd-evidence-chain]');
    expect(landingSource).toContain("<ThemeSignatureExperience");
    expect(themeEncounterSource).toContain('data-cstd-theme-encounter-theme="neon-district"');
    expect(themeEncounterSource).toContain('data-cstd-theme-encounter-theme="underworld-forge"');
    expect(themeEncounterSource).toContain('data-cstd-theme-encounter-theme="astral-covenant"');
    expect(themeEncounterSource).toContain('data-cstd-neon-breach-node={index + 1}');
    expect(themeEncounterSource).toContain('data-cstd-underworld-boon={boon.id}');
    expect(themeEncounterSource).toContain('data-cstd-astral-roll');
    expect(themeEncounterSource).toContain('emitSignatureMetric("breach")');
    expect(themeEncounterSource).toContain('emitSignatureMetric("boon")');
    expect(themeEncounterSource).toContain('emitSignatureMetric("roll")');
  });

  test("keeps three distinct licensed type, material, artifact, and motion grammars", () => {
    ...
    expect(astralThemeSource).toContain('font-family: "CSTD Astral Display"');
    expect(themeFoundationSource).toContain('[data-cstd-theme="neon-district"][data-cstd-locale="en"]');
    expect(themeWorldSource).toContain('en: "BREACH"');
    expect(themeWorldSource).toContain('en: "RETURN"');
    expect(themeWorldSource).toContain('en: "LEGACY"');
    ...
    expect(astralThemeSource).toContain('/cstd-materials/astral-vellum-v1.webp');
    expect(themeFoundationSource).toContain("cstd-neon-heading-lock");
    expect(themeEncounterCssSource).toContain("cstd-neon-node-pulse");
    expect(themeEncounterCssSource).toContain("cstd-underworld-slash");
    expect(themeEncounterCssSource).toContain("cstd-astral-die-cast");
    ...
    expect(pageHeroSource).toContain('data-cstd-deep-artifact="astral"');
  });
});
