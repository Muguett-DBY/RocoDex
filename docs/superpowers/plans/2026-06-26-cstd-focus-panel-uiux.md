# CSTD Focus Panel UIUX Plan

Goal: Upgrade the project focus panel into a clearer scan-and-act case-study surface.

Checklist:

- [x] Add failing tests for checklist summary text and responsive focus panel layout classes.
