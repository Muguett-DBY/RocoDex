# CSTD Evidence Overview Plan

Goal: Add a visible project evidence overview to the CSTD homepage project section.

Checklist:

- [x] Add a failing helper test for live/incubating project evidence counts and summary text.
