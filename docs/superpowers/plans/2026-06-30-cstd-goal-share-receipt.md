# CSTD Goal Share Receipt Plan

- [x] Define the restored-goal receipt scope and avoid changing the URL contract.
- [x] Add failing tests for restored goal-share receipt copy.
