# CSTD Project Evidence Checklist Plan

Goal: Add a per-project evidence checklist to the CSTD project focus panel.

Checklist:

- [x] Add a failing helper test for role/problem/outcome/current evidence checklist items.
