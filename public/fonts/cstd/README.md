...
The corresponding license text is stored beside these files. The homepage preloads only the persisted active theme's font files; inactive faces remain lazy.
